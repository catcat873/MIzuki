...
## 🆕 v4.4 版本更新
- **岁月浅吟功能：** 新增专门用于记录日常生活的内容类型，支持心情、天气、地点等生活化元信息，提供精选功能和按月分组展示。
...
- **岁月浅吟：** 在 `src/content/memories/` 中创建生活记录文章
...
- **创建生活记录：** 在 `src/content/memories/` 创建 `.md` 文件
- **文件命名：** 使用 `YYYY-MM-DD-标题.md` 格式
- **元信息支持：** 心情、天气、地点等生活化标签
- **精选功能：** 可以标记重要文章为精选
- **图片存储：** 专门存储在 `public/images/memories/` 目录
- **访问方式：** 导航栏 → "我的" → "岁月浅吟"
